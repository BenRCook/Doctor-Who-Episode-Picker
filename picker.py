...
series_1_var = IntVar()
series_1_var.set(1)
series_1_checkbutton = Checkbutton(series_frame, text="series 1", variable = series_1_var).grid(row=0, column=0)
series_2_var = IntVar()
series_2_var.set(1)
series_2_checkbutton = Checkbutton(series_frame, text="series 2", variable = series_2_var).grid(row=0, column=1)
series_3_var = IntVar()
series_3_var.set(1)
series_3_checkbutton = Checkbutton(series_frame, text="series 3", variable = series_3_var).grid(row=0, column=2)
series_4_var = IntVar()
series_4_var.set(1)
series_4_checkbutton = Checkbutton(series_frame, text="series 4", variable = series_4_var).grid(row=0, column=3)
series_5_var = IntVar()
series_5_var.set(1)
series_5_checkbutton = Checkbutton(series_frame, text="series 5", variable = series_5_var).grid(row=0, column=4)
series_6_var = IntVar()
series_6_var.set(1)
series_6_checkbutton = Checkbutton(series_frame, text="series 6", variable = series_6_var).grid(row=1, column=0)
series_7_var = IntVar()
series_7_var.set(1)
series_7_checkbutton = Checkbutton(series_frame, text="series 7", variable = series_7_var).grid(row=1, column=1)
series_8_var = IntVar()
series_8_var.set(1)
series_8_checkbutton = Checkbutton(series_frame, text="series 8", variable = series_8_var).grid(row=1, column=2)
series_9_var = IntVar()
series_9_var.set(1)
series_9_checkbutton = Checkbutton(series_frame, text="series 9", variable = series_9_var).grid(row=1, column=3)
series_10_var = IntVar()
series_10_var.set(1)
series_10_checkbutton = Checkbutton(series_frame, text="series 10", variable = series_10_var).grid(row=1, column=4)
series_11_var = IntVar()
series_11_var.set(1)
series_11_checkbutton = Checkbutton(series_frame, text="series 11", variable = series_11_var).grid(row=2, column=1)
series_12_var = IntVar()
series_12_var.set(1)
series_12_checkbutton = Checkbutton(series_frame, text="series 12", variable = series_12_var).grid(row=2, column=2)
series_13_var = IntVar()
series_13_var.set(1)
series_13_checkbutton = Checkbutton(series_frame, text="series 13", variable = series_13_var).grid(row=2, column=3)
